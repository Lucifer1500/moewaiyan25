...
def main_apv():
    ...
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/Lucifer1500/SKB/blob/main/Aprove.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            print('\033[1;92m [\033[1;92m1\033[1;92m]\033[1;92m 30000mmk \033[1;92mApproval For 1 month')
            print(' \033[1;92m[\033[1;92m2\033[1;92m]\033[1;92m 20000mmk \033[1;92mApproval For 15 days')
            print(' \033[1;92m[\033[1;92m3\033[1;92m]\033[1;92m 10000mmk \033[1;92mApproval For 7 days \033[1;37m')
            print('\033[1;92m-----------------------------------------------------')
